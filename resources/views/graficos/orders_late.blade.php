            ...
            <div class="card d-flex justify-content-center text-center mt-2">
                <div class="row card-body">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        ...
                        <button type="button" class="btn btn-success btn-sm mt-1" onclick="orders_date()">
...
<script>
    ...
    Highcharts.chart('grafico1', {
        ...
        subtitle: {
            align: 'left',
            text: 'Ver total de ordenes fuera de fecha de entrega por mes'
        },
        accessibility: {
            announceNewData: {
                enabled: true
        ...
        yAxis: {
            title: {
                text: 'Total de ordenes con retraso'
            }
        ...
        series: [{
            name: 'Ordenes retrasadas',
            colorByPoint: true,
            data: <?= $data1 ?>
        }]
    });

    function orders_date() {
