    ...
    <div class="row">
        <h1 class="col-form-label col-form-label-md text-dark" style="background-color: rgb(204,204,204)">PROYECTO: {{$project->name}}
            ...
            <div class="progress mt-2" style="width:25%">
                @if($avance < 40) 
                    <div style="width:{{$avance . '%'}}" class="progress-bar progress-bar-striped bg-secondary progress-bar-animated progress-project"></div>
                @elseif($avance >= 40 && $avance < 80) 
                    <div style="width:{{$avance . '%'}}" class="progress-bar progress-bar-striped bg-warning progress-bar-animated progress-project"></div>
                @elseif($avance >= 80)
